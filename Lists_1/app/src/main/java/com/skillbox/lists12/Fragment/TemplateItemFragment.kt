        ...
        when(TYPE_FORM){
            Pet.Cat.TYPE_MODEL -> {
                ...
                btAddDog.setOnClickListener {
                    (fragmentManager?.findFragmentByTag("PersonListFragment") as? ItemCliickListener)?.setItemClick(Pet.Cat(
            ...
            Pet.Dog.TYPE_MODEL -> {
                ...
                btAddDog.setOnClickListener {
                    (fragmentManager?.findFragmentByTag("PersonListFragment") as? ItemCliickListener)?.setItemClick(Pet.Dog(
                        editTextCatName.text.toString(),
